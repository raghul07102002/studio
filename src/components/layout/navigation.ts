import { LayoutDashboard, CalendarDays, Settings, DollarSign, History, Briefcase, Plane, Map, AlarmClock, ListChecks } from "lucide-react";
...
export const travelNavItems = [
    ...
    { href: "/travel/plan", icon: ListChecks, label: "Plan" },
];
